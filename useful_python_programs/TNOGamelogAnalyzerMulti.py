...
#Running the game.log analyzer requires a command prompt/terminal and for you to have Python 3 installed on your computer. To run it, first navigate to the directory containing LLWGamelogAnalyzerMulti.py in the command prompt/terminal with the cd command. Now, type the name of the program (LLWGamelogAnalyzerMulti.py) into the command prompt, followed by the name of the directory containing your game.log files. The program will automatically scan the directory you give it, including all subdirectories, and find all files ending with the string "game.log" and analyze them.
...
#followed by
#LLWGamelogAnalyzerMulti.py C:\Users\uncountably\cool-data
